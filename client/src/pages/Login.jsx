            ...
            <div className={`cont ${isRightPanelActive ? 'right-panel-active' : ''} bg-gray-800 rounded-lg shadow-2xl shadow-orange-50 relative overflow-hidden w-full max-w-4xl min-h-120`}>
                ...
                <div className="form-container sign-up-container absolute top-0 left-0 w-1/2 h-full">
                    <div className="bg-gray-950 flex items-center justify-center flex-col px-12 h-full text-center">
                        ...
                        <input type="text" name="name" className='bg-gray-200 text-black border-none py-3 px-4 my-2 w-full rounded text-sm' placeholder='Name' value={signUpData.name} onChange={(e) => setSignUpData({ ...signUpData, name: e.target.value })} />
                ...
                <div className="form-container sign-in-container absolute top-0 left-0 w-1/2 h-full">
                    <div className="bg-gray-950 flex items-center justify-center flex-col px-12 h-full text-center">
                        ...
                        <input type="email" name="email" id="email" placeholder="Email" className='bg-gray-200 text-black border-none py-3 px-4 my-2 w-full rounded text-sm' value={loginData.email} onChange={(e) => setLoginData({ ...loginData, email: e.target.value })} />
                        <input type="password" name="password" id="password" placeholder="Password" className='bg-gray-200 text-black border-none py-3 px-4 my-2 w-full rounded text-sm' value={loginData.password} onChange={(e) => setLoginData({ ...loginData, password: e.target.value })} />
                        ...
                        <button onClick={handleLoginSubmit} className="btn-style rounded-full border border-red-500 bg-red-500 text-white text-xs font-bold py-3 px-11 tracking-wide uppercase transition-transform duration-75 hover:bg-red-600">Sign In</button>
                    </div>
                </div>
                ...
                <div className="overlay-container absolute top-0 left-1/2 w-1/2 h-full overflow-hidden z-50">
                    <div className="overlay relative -left-full h-full w-full text-white" style={{ width: '200%' }}>
                        <div className="overlay-panel overlay-left absolute flex items-center justify-center flex-col px-10 text-center top-0 h-full w-1/2">
                            ...
                            <button onClick={handleLoginClick} className="btn-style rounded-full border border-white bg-transparent text-white text-xs font-bold py-3 px-11 tracking-wide uppercase transition-transform duration-75 hover:bg-white hover:text-red-500">Sign In</button>
                        </div>
